...
const SharePost = () => {
  return (
    ...
    dark:border-gray-700 dark:bg-black/60 dark:text-white">
      <div className="flex gap-5">
        <img
          src={pp}
          alt=""
          className="w-20 cursor-pointer rounded-full border-2 transition-all duration-200
        ...
        <textarea
          ...
          className="w-full resize-none rounded-2xl border p-3 shadow-md outline-nonde ring-transparent transition-all
            duration-200 hover:bg-gray-50 focus:-translate-y-1 focus:bg-gray-100 focus:shadow-xl focus:ring-2 focus:ring-blue-500
            dark:border-gray-700 dark:bg-black dark:focus:bg-gray-900"
        ></textarea>
      </div>
