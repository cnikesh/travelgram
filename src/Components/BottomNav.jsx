...
const BottomNav = ({toggleDarkMode, darkMode}) => {
  return (
    <ul className='fixed bottom-0 flex w-full list-none justify-around border-t bg-white/60 p-3 shadow-lg 
    backdrop-blur-md xl:hidden dark:border-gray-700 dark:border-t-gray-700 dark:bg-black/60 dark:text-white'>
